            ...
            >
              ...
              <UIFieldGroup class="grid grid-cols-1 md:grid-cols-2">
                ...
                <form.Field name="pharmacyName">
                  <template #default="{ field }">
                    <UIField>
                      <UIFieldLabel for="pharmacyName"
                        >Pharmacy Name</UIFieldLabel
                      >
                      <UIInput
                        id="pharmacyName"
                        v-model="field.state.value"
                  ...
                  <template #default="{ field }">
                    <UIField>
                      <UIFieldLabel for="licenseNumber"
                        >Pharmacy License Number</UIFieldLabel
                      >
                      <UIInput
                        id="licenseNumber"
                        v-model="field.state.value"
                  ...
                  <template #default="{ field }">
                    <UIField>
                      <UIFieldLabel for="email"
                        >Contact Email Address</UIFieldLabel
                      >
                      <UIInput
                        id="email"
                        v-model="field.state.value"
              ...
              <form.Field name="services" class="my-4">
                <template #default="{ field }">
                  <UIField>
                    ...
                    >
                      <div
                        v-for="service of services.pharmacyServices"
                        :key="service.id"
              ...
              <div class="space-y-3">
                <div
                  class="space-y-2 rounded-lg border border-border p-4 bg-muted/30"
                >
                  <form.Field name="operatingHours">
                    <template #default="{ field }">
                      <UIField>
                        ...
                        >
                          <div
                            class="flex items-center gap-2 lg:w-[25%] w-[35%]"
                          >
                            <UISwitch
                              :model-value="
                                !!field.state.value[
                          ...
                          >
                                  ...
                                  (value: string | any) => {
                                    ...
                                    if (!updatedHours[dayKey]) {
                                      updatedHours[dayKey] = {
                                        ...
                                        close:
                                          field.state.value[dayKey]?.close ||
                                          '',
                                        is24Hours: false,
                                        enabled: true,
                                      };
                            ...
                            <div
                              v-else
                              class="text-sm text-muted-foreground align-center"
                            >
                              Open 24 Hours
                            </div>
                          </div>
